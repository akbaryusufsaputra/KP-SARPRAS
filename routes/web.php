...
//route print
Route::get('/printbarang', 'PrintController@printbarang');
Route::get('/printpinjam', 'PrintController@printpinjam');
Route::get('/printhilang', 'PrintController@printhilang');
Route::get('/printrusak', 'PrintController@printrusak');
